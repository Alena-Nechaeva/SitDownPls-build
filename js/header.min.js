...
/***/ "./src/js/header/modules/cart-&-login.js":
/*!***********************************************!*\
  !*** ./src/js/header/modules/cart-&-login.js ***!
  \***********************************************/
...
/* harmony export */   "cartAndLogin": () => (/* binding */ cartAndLogin)
/* harmony export */ });
const cartAndLogin = () => {
  const cartLogin = document.createElement('div');
  const cartBtn = document.createElement('button');
  const loginBtn = document.createElement('button');
  const purchaseNumber = document.createElement('span');
  cartLogin.classList.add('cart-login');
  cartBtn.classList.add('cart-login__cart', 'cart');
  loginBtn.classList.add('cart-login__login');
  purchaseNumber.classList.add('cart__number');
  cartBtn.ariaLabel = 'Корзина';
  loginBtn.ariaLabel = 'Войти в личный кабинет';
  cartBtn.innerHTML = `
  ...
  `;
  purchaseNumber.textContent = 0;
  cartBtn.prepend(purchaseNumber);
  cartLogin.append(loginBtn, cartBtn);
  return cartLogin;
};

/***/ }),

/***/ "./src/js/header/modules/libs-active-header.js":
/*!*****************************************************!*\
  !*** ./src/js/header/modules/libs-active-header.js ***!
  \*****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "libsActiveHeader": () => (/* binding */ libsActiveHeader)
/* harmony export */ });
const libsActiveHeader = () => {
...
/***/ "./src/js/header/modules/logo-320.js":
/*!*******************************************!*\
  !*** ./src/js/header/modules/logo-320.js ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "createLogo320": () => (/* binding */ createLogo320)
/* harmony export */ });
const createLogo320 = () => {
...
/***/ "./src/js/header/modules/on-resize-header.js":
/*!***************************************************!*\
  !*** ./src/js/header/modules/on-resize-header.js ***!
  \***************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "onResizeHeader": () => (/* binding */ onResizeHeader)
/* harmony export */ });
/* harmony import */ var _cart_login_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./cart-&-login.js */ "./src/js/header/modules/cart-&-login.js");
/* harmony import */ var _logo_320_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./logo-320.js */ "./src/js/header/modules/logo-320.js");


const onResizeHeader = () => {
  const cartLogin = (0,_cart_login_js__WEBPACK_IMPORTED_MODULE_0__.cartAndLogin)();
  ...
  const logoMobile = (0,_logo_320_js__WEBPACK_IMPORTED_MODULE_1__.createLogo320)();
...
/*!*********************************!*\
  ...
  \*********************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _modules_on_resize_header_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/on-resize-header.js */ "./src/js/header/modules/on-resize-header.js");
/* harmony import */ var _modules_libs_active_header_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/libs-active-header.js */ "./src/js/header/modules/libs-active-header.js");
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  (0,_modules_on_resize_header_js__WEBPACK_IMPORTED_MODULE_0__.onResizeHeader)();
  (0,_modules_libs_active_header_js__WEBPACK_IMPORTED_MODULE_1__.libsActiveHeader)();
